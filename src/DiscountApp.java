public class DiscountApp {
    public static void main(String[] args) {
        ...
        double price1 = 1100;
        Client client2 = new Client("Janina", "Kowalska", false);
        double price2 = 1100;

        DiscountService discountService = new DiscountService();

        double priceDiscount1 = discountService.getDiscount(client1, price1);
        double priceDiscount2 = discountService.getDiscount(client2, price2);
